...
<<<<<<< HEAD
        ...
        self.assertEqual(content.description_es, "Descriptif Détaillé")
...
=======
        ...
        self.assertEqual(content.name, u"Test EN")
        self.assertEqual(content.name_en, u"Test EN")
        self.assertEqual(content.name_es, u"Test ES")
        self.assertEqual(content.name_fr, u"Quey' Raft")
        self.assertEqual(content.description, u"Descriptif Détaillé EN")
        self.assertEqual(content.description_fr[:27], u"Au pied du château médiéval")
        self.assertEqual(content.description_en, u"Descriptif Détaillé EN")
        ...
        self.assertEqual(content.description_teaser_it, u"Descriptif Court IT")
